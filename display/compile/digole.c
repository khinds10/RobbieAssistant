...
#include "Metroid.h"
#include "PunchOut.h"
#include "SuperMario2.h"
#include "SuperMario3.h"
#include "TMNT2.h"
#include "TopGun.h"
#include "Turtles.h"
#include "Zelda.h"
...
void drawBitmap256(uint8_t x, uint8_t y, uint8_t w, uint8_t h, unsigned char *bitmap,uint8_t c ) {
	int j;
    writecmd("EDIM1");
    writebyte(x);
    writebyte(y);
...
void drawBitmapc(uint8_t x, uint8_t y, uint8_t w, uint8_t h, unsigned char *bitmap,uint8_t c ) {
    uint8_t i = 0;
	int j;
	if (c!=0) c=0xff;
    if ((w & 7) != 0)
...
int main (int argc, char* argv[]) {
    ...
    } else if (strcmp(digoleCommand, "drawBitmap256") == 0) {
    ...
    } else if (strcmp(digoleCommand, "BlasterMaster") == 0) {
        drawBitmap256(0, 0, 128, 120, &BlasterMaster,0);
    } else if (strcmp(digoleCommand, "Castlevania") == 0) {
        drawBitmap256(0, 0, 128, 112, &Castlevania,0);
    } else if (strcmp(digoleCommand, "ChipDale") == 0) {
        drawBitmap256(0, 0, 128, 120, &ChipDale,0);
    } else if (strcmp(digoleCommand, "Contra") == 0) {
        drawBitmap256(0, 0, 128, 120, &Contra,0);
    } else if (strcmp(digoleCommand, "DuckTales") == 0) {
        drawBitmap256(0, 0, 128, 112, &DuckTales,0);
    } else if (strcmp(digoleCommand, "Galaga") == 0) {
        drawBitmap256(0, 0, 128, 112, &Galaga,0);
    } else if (strcmp(digoleCommand, "GhostBusters") == 0) {
        drawBitmap256(0, 0, 128, 122, &GhostBusters,0);
    } else if (strcmp(digoleCommand, "Gradius") == 0) {
        drawBitmap256(0, 0, 128, 120, &Gradius,0);
    } else if (strcmp(digoleCommand, "KidIcarus") == 0) {
        drawBitmap256(0, 0, 128, 112, &KidIcarus,0);
    } else if (strcmp(digoleCommand, "MarbleMadness") == 0) {
        drawBitmap256(0, 0, 128, 120, &MarbleMadness,0);
    } else if (strcmp(digoleCommand, "MegaMan") == 0) {
        drawBitmap256(0, 0, 128, 120, &MegaMan,0);
    } else if (strcmp(digoleCommand, "MetalGear") == 0) {
        drawBitmap256(0, 0, 128, 120, &MetalGear,0);
    } else if (strcmp(digoleCommand, "Metroid") == 0) {
        drawBitmap256(0, 0, 128, 107, &Metroid,0);
    } else if (strcmp(digoleCommand, "PunchOut") == 0) {
        drawBitmap256(0, 0, 128, 112, &PunchOut,0);
    } else if (strcmp(digoleCommand, "SuperMario2") == 0) {
        drawBitmap256(0, 0, 128, 120, &SuperMario2,0);
    } else if (strcmp(digoleCommand, "SuperMario3") == 0) {
        drawBitmap256(0, 0, 128, 115, &SuperMario3,0);
    } else if (strcmp(digoleCommand, "TMNT2") == 0) {
        drawBitmap256(0, 0, 128, 112, &TMNT2,0);
    } else if (strcmp(digoleCommand, "TopGun") == 0) {
        drawBitmap256(0, 0, 128, 112, &TopGun,0);
    } else if (strcmp(digoleCommand, "Turtles") == 0) {
